...
public class TaskerDaoJdbcTemplateImpl implements TaskerDao {
    ...
    public Task getTask(int id) {
        try {
            return jdbcTemplate.queryForObject(SELECT_TASK_BY_ID, this::mapToRowTask, id);
    ...
    public List<Task> getAllTasks() {
        return jdbcTemplate.query(SELECT_ALL_TASKS, this::mapToRowTask);
    }

    @Override
    public List<Task> getTasksByCategory(String category) {
        return jdbcTemplate.query(SELECT_TASKS_BY_CATEGORY, this::mapToRowTask, category);
    }
    ...
    private Task mapToRowTask(ResultSet rs, int rowNum) throws SQLException {
        Task task = new Task();
