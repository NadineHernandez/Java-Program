...
public class RectPavingCompany {
    ...
    public static void main(String[] args) {
        ...
        framingCost = Float.parseFloat(scan.nextLine()); //cementCost variable was used instead of framingCost

        int area = length * width;
        int perimeter = 2*length + 2*width; //Incorrect operator. Changed 2*length - 2*width to addition
        ...
        System.out.format("The cost of the framing/footers is %f.%n", perimeter*framingCost);//changed perimeter+framingCost to *
    }
}
